  ...
  return (
    <div className="relative aspect-[292/142] h-7">
      <input
        ...
        checked={songAddStatus}
        onChange={allowSongAdd}
      />
      <svg
      ...
      >
        ...
        <rect
          ...
          x={64}
          className={`transition-colors duration-400 ${
            songAddStatus ? "fill-white" : "fill-gray-300"
          }`}
        />
        ...
        <g filter="url('#goo')">
          <rect
            ...
            className={`transition-transform duration-600 ${
              songAddStatus ? "translate-x-[150px]" : "translate-x-0"
            }`}
          />
          <rect
            fill="#fff"
            ...
            className={`transition-transform duration-450 ${
              songAddStatus ? "scale-0" : "scale-100"
            }`}
          />
          <rect
            fill="#fff"
            ...
            x={164}
            className={`transition-transform duration-450 ${
              songAddStatus ? "scale-100" : "scale-0"
            }`}
          />
        </g>
